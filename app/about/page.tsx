      ...
      <section className="bg-warm-gradient">
        <div className="max-w-3xl mx-auto px-6 py-20">
          ...
          <div className="mt-14 panel p-10 text-center bg-cream">
            <h2 className="text-2xl font-bold mb-3" style={{ color: "#3D2B1F" }}>Want to place an order?</h2>
            <p className="mb-7 leading-relaxed" style={{ color: "#6B5740" }}>Browse our menu and add your favorites to the cart.</p>
