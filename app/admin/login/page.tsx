    ...
    <div className="bg-surface flex items-center justify-center px-6 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-4 border surface-divider bg-[rgba(224,215,255,0.75)] text-fh-heading">
            <svg
              width="28"
              height="28"
              viewBox="0 0 24 24"
          ...
          <h1 className="text-2xl font-bold text-fh-heading">Flour Haus</h1>
          <p className="text-sm mt-1 text-fh-muted">Admin Portal</p>
        </div>
