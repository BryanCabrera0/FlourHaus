      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <header className="panel p-4 sm:p-5 mb-8 flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
          <div className="flex items-center gap-3">
            <div>
              <p className="kicker kicker-accent">Flour Haus Admin</p>
              <p className="text-xs mt-0.5 text-fh-muted">{session.email}</p>
            </div>
          </div>
          <nav className="flex items-center gap-2 flex-wrap">
            ...
            <Link
              href="/"
              className="btn-admin-nav py-2 px-3 text-[0.7rem]"
            >
              Back to site
            </Link>
            <AdminLogoutButton />
